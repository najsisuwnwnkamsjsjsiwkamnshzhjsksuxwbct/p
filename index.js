...
const vcard = 'BEGIN:VCARD\n' // ANAK ANJING MAU NGAPAIN?
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6285722553839:+62-8572-2553\n' // JANGAN KEK BABI SU
            + 'END:VCARD'
prefix = '!'
blocked = []
		   ...
		   case 'marvelogo':
               ...
               case 'infogempa':
				...
				if (body.startsWith(`${prefix}${command}`)) {
                  reply(`Maaf, Command *${prefix}${command}* Tidak Terdaftar Di Dalam *${prefix}menu*!`)
                  }
